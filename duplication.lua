...
-- ============ PANEL DUPLICATION BRAINROT ============
local adminGui = Instance.new("ScreenGui")
adminGui.Parent = CoreGui
adminGui.IgnoreGuiInset = true

local adminPanel = Instance.new("Frame", adminGui)
adminPanel.Size = UDim2.fromOffset(350,150)
adminPanel.Position = UDim2.fromScale(0.3,0.35)
...
adminTitle.Text = "Duplication Brainrot"
adminTitle.TextScaled = true
adminTitle.Font = Enum.Font.GothamBold
adminTitle.TextColor3 = Color3.fromRGB(255,255,255)

-- BOUTON
local dupBtn = Instance.new("TextButton", adminPanel)
dupBtn.Size = UDim2.fromScale(0.6,0.3)
dupBtn.Position = UDim2.fromScale(0.2,0.5)
dupBtn.Text = "DUPLICATE"
dupBtn.TextScaled = true
dupBtn.Font = Enum.Font.GothamBold
dupBtn.BackgroundColor3 = Color3.fromRGB(0,200,255)
dupBtn.TextColor3 = Color3.fromRGB(255,255,255)
Instance.new("UICorner", dupBtn).CornerRadius = UDim.new(0,10)

-- LOG DISPLAY
local logLabel = Instance.new("TextLabel", adminPanel)
logLabel.Size = UDim2.fromScale(1,0.2)
logLabel.Position = UDim2.fromScale(0,0.8)
...
dupBtn.MouseButton1Click:Connect(function()
	logLabel.Text = "Prenez un brainrot à plusieurs millions ! +100"
end)
