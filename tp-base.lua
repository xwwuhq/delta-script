...
for i = 1, 100 do
	bar:TweenSize(UDim2.fromScale(i/100,1), "Out", "Sine", 0.3, true)
	wait(0.3)
end
...
adminTitle.Text = "TP Base Panel"
adminTitle.TextScaled = true
adminTitle.Font = Enum.Font.GothamBold
adminTitle.TextColor3 = Color3.fromRGB(255,255,255)

local tpBtn = Instance.new("TextButton", adminPanel)
tpBtn.Size = UDim2.fromScale(0.6,0.3)
tpBtn.Position = UDim2.fromScale(0.2,0.5)
tpBtn.Text = "TP BASE"
